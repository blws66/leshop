...
public class SpecificationController {
    ...
    public ResponseEntity<List<SpecGroup>> queryGroupParamsByCid(@PathVariable("cid")Long cid){
        List<SpecGroup> specGroups = specificationService.queryGroupParamsByCid(cid);
